<?php namespace App\Http\Controllers;
	...
	class AdminOutboxController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Dispositivo','name'=>'id_device','type'=>'select2','validation'=>'required','width'=>'col-sm-10','datatable'=>'device,name','help'=>'Muestra los dispositivos conectados','datatable_where'=>'status="AUTHENTICATED"'];
			$this->form[] = ['label'=>'Tipo','name'=>'type','type'=>'select2','validation'=>'required','width'=>'col-sm-10','dataenum'=>'Text;Button;Image;Video;PDF'];
			$this->form[] = ['label'=>'Celular','name'=>'number','type'=>'multitext','validation'=>'required|min:1','width'=>'col-sm-10'];
	...
	//		echo $this->formatNumber($number);
		...
		//	dd($number);
			...
			if($postdata['type'] == "Text"){
				...
				$buttonMessage = [
					'text' => $postdata['text'],
					'footer' => 'edward.rodriguez@gmail.com',
					'buttons' => $buttons,
					'headerType' => 1
				];
				$body = $buttonMessage;
