...
@section('content')
  ...
  <div class='panel panel-default'>
          ...
          <div for="" class=" col-sm-6">
            <div class="_2WuPw">
                ...
                <ol class="_2A31C">
                  ...
                  <li class="QtrYx">
                    <span dir="ltr" class="i0jNr">Selecciona <strong>
                        <span dir="ltr" class="i0jNr">Menú <span class="_30yMe">
                        ...
                        <span dir="ltr" class="i0jNr">Ajustes <span class="_30yMe">
                      ...
                      </strong> y selecciona <strong>Dispositivos Vinculados</strong>
                    </span>
                  </li>
                  <li class="QtrYx">
                    Apunta tu teléfono a esta pantalla para capturar el código QR, espera un momento mientras se ejecuta
                  </li>
                </ol>
              </div>          
            </div>
    ...
    <div class='panel-footer'>
      <a  class='btn btn-primary' href="{{ CRUDBooster::mainpath('') }}"  value='Back'/>VOLVER</a>
    </div>
  </div>
@endsection